...
I assume the type-safety guarantee works by constrained decoding, a very old simple trick[^constrained_decoding] but admittedly under-exploited. We can't verify the specific objective or architecture, as it's not open-source.

[^constrained_decoding]: I'm not sure when this was first introduced, but there's clear precedent in [PICARD: Scholak, et al, 2021](https://arxiv.org/abs/2109.05093) and [Grid Beam Search: Hokamp & Liu, 2017](https://arxiv.org/abs/1704.07138)
